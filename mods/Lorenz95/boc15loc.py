...
# Suggested tuning
####################
# Reproduce data point L=10 from figure 6.a                               # Expected RMSE_a:
# cfgs += iLEnKS('Sqrt' ,infl=1.02, N=10,iMax=4,Lag=10,loc_rad=12/1.82)   # 0.17
# cfgs += iLEnKS('-N' ,             N=10,iMax=4,Lag=10,loc_rad=12/1.82)   # 0.18

# Reproduce data point dt=0.4 from figure 5
# cfgs += iEnKS ('-N' , N=20,iMax=4,Lag=2)                                # 0.39
# cfgs += iLEnKS('-N' , N=10,iMax=4,Lag=2,loc_rad=12/1.82)                # 0.44

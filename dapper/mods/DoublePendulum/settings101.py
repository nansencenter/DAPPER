...
# HMM.tseq.dkObs = anything
# xps += Climatology()                                 # 5
# xps += OptInterp()                                   # 2.5

# HMM.tseq.dkObs = 7 # <-- max dkObs for tolerable performance with Var3D
...
# HMM.tseq.dkObs = 20 # <-- max dkObs for tolerable performance with ExtKF
...
# HMM.tseq.dkObs = 30 # <-- for larger dkObs, EnKF deteriorates quickly

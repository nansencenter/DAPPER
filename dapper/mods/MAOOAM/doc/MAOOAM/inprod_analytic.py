"""
	...
	.. note :: These are calculated using the analytical expressions from De Cruz, L., Demaeyer, \
 	...
 	.. note :: The python code is available here : `inprod_analytic.py <../_modules/inprod_analytic.html>`_ and on `Git <https://github.com/nansencenter/DAPPER/blob/max1/mods/MAOOAM/inprod_analytic.py>`_.
	...
	* ocean_tensors(noc)
"""
from params2 import nbatm, nboc, natm,noc,n,oms,ams,pi
...
class atm_tensors :
	...
	* The object will be name `atmos`.
	...
	def calculate_g(self) :
		...
		.. note:: This is a strict function: it only accepts AKL KKL and LLL types.
			For any other combination, it will not calculate anything.
		"""
...
class ocean_tensors :
	...
	* The object will be name ocean
	...
	def calculate_C_oc(self) :
		...
		.. note :: Requires :math:`O_{i,j,k}` and :math:`M_{i,j}` to be calculated beforehand.
		"""
		if (noc==0) :
...
#Definition of the Helper functions from Cehelsky Tung
#=====================================================

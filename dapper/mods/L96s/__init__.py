...
def l96s_tay2_step(x, t, dt):
    ...
    See `bib.grudzien2020numerical` for full details of the scheme and other versions."""
    ...
    # draw standard normal sample to define the recursive Stratonovich integral coefficients
